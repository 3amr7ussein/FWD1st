        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    originalImgPath = path_1.default.join(path_1.default.resolve('./'), 'assets', 'full', "".concat(fileName, ".jpg"));
                    if (!(fileName != '')) return [3 /*break*/, 3];
                    if (!(width && height)) return [3 /*break*/, 2];
                    resizedImgPath_1 = path_1.default.join(path_1.default.resolve('./'), 'assets', 'thumb', "".concat(fileName).concat(width).concat(height, ".jpg"));
