    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          if (
            !(
              (0, fileExistCheckers_1.isResizedImgExists)(resizedImgPath_1) ==
              false
            )
          )
            return [3 /*break*/, 2];
          if (!(0, fileExistCheckers_1.isOriginalImgExists)(originalImgPath))
            return [3 /*break*/, 2];
          //create resized images
          console.log('Creating Resized Image');
          return [
            4 /*yield*/,
            (0, resizeImg_1.imgResize)(originalImgPath, +width, +height)
              .toBuffer()
              .then(function (data) {
