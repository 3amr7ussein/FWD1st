...
imageApi.get('/', function (req, res) {
    ...
    var fullPath = path_1.default.join(path_1.default.resolve('./'), 'assets', 'full', "".concat(fileName, ".jpg"));
    if (!width && !height) {
        ...
        var resizedPath = path_1.default.join(path_1.default.resolve('./'), 'assets', 'thumb', "".concat(fileName).concat(width).concat(height, ".jpg"));
